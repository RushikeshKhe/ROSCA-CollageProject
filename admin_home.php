...
<body>
    ...
    <div class="container">
    <h1 style="size:10px" class="section-title">Welcome admin</h1>
        ...
        <div class="services">
            ...
            <div class="service-card">
                ...
                <a href="create_g.php" class="read-more">Read More</a>
            </div>
            <div class="service-card">
                <h3>Manage Transactions</h3>
                
                <a href="trans_update.php" class="read-more">Read More</a>
            </div>
        </div>
    </div>
